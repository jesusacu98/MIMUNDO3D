...
export default function CatalogoClient({ products, categoryNames, colors }: CatalogoClientProps) {
          ...
          >
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-6 border-t border-zinc-100">
                <span className="text-2xl font-extrabold text-zinc-950">{formatPrice(selectedProduct)}</span>
                <button
                  onClick={() => {
